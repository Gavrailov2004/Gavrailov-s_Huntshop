...
<body>
  <div class="Hero">
     ...
     <section>
        <h1>Следене на пратка</h1>
        <h2>От официалния сайт на еконт или спиди може да се следи поръчката.</h2>
        <h2>За оръжие не може да се следи, просто чакате за обаждане от местния ви оръжеен магазин.</h2>
     </section>
     <footer class="footer">
