...
<body>
  <div class="Hero">
     ...
     <section>
        ...
        <br>
        <h2>ПОЛИТИКА-ПРАВИЛНИК ПРОЦЕДУРА ЗА ПОВЕРИТЕЛНОСТ И ЗАЩИТА НА ЛИЧНИТЕ ДАННИ НА „Gavrailov's_shop“ EООД, ЕИК: 201121843</h2>
        <br>
        <h2>„Gavrailov's_shop“ EООД клиентите и доставчиците заявяват, са запознати с доброволния характер и методите за събиране и обработване на лични данни, за целите на изпълнение на покупки на оръжия и др. предмети и стоки от „Gavrailov's_shop“ EООД и че приемат тези условия, включително че дават съгласието си за размножаване и поддържане на документите, съдържащи лични данни, предоставени във връзка с направена покупка. Настоящата правилник процедура за поверителност регулира обработването на лични данни на физически лица или представители на юридически лица на наши клиенти или потенциални такива, както и потребители на нашия уебсайт: http://Gavrailov's_Huntshop.com („Сайта“), във връзка с услугите, предоставяни от „Gavrailov's_shop“ EООД, включително предоставяни чрез и достъпни на Сайта.</h2>
        <br>
        <h2>Моля, прочетете внимателно настоящият документ преди да използвате Сайта или да предоставите Личните си данни, независимо дали по електронен път на Сайта или на хартия, тъй като с предоставянето на Личните си данни Вие се съгласявате с настоящият правилник процедура за поверителност . Ако не желаете да обработваме личните Ви данни по методите, описан в настоящият правилник процедура за поверителност, моля не ни ги предоставяйте. Предоставянето на лични данни от Ваша страна е доброволно.</h2>
     </section>
     <footer class="footer">
