      ...
      <table class="product-display-table">
        ...
        <?php while($row = mysqli_fetch_assoc($select)){ ?>
         ...
         <tr>
            ...
            <td>
               <a href="updateNews.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i> Промени </a><br>
               <a href="changeNews.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> Изтрий </a>
            </td>
         </tr>
      <?php } ?>
      </table>
