...
<head>
    ...
    <title>Комплект за оцеляване</title>
</head>
<body>
    <div class="Hero">
        <nav class="nav1">
      ...
      $row_count = mysqli_num_rows($select_rows);?>
        ...
        <div class="pistolsSection">
            <section class="products">
               <h1 class="heading">Всичко за комплекта за оцеляване</h1>
              <div class="box-container">
                  <?php
                  $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Комплект за оцеляване'");
