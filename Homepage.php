...
<body>
  <div class="Hero">
     ...
     <div class="slideshow-container">
      ...
      <div class="mySlides fade">
        <img src="images/Без име.png" height="400px" width="1550px">
      </div>
    ...
    <br>
    <br>
    <div class="titleContainer"><h1>Предложени за вас</h1></div>
    <section class="container"><br>
      <div class="card" id="card1">
        <div class="image">
          <img src="images/Rifle.jpg" alt="">
        </div>
        <a href="#"><h2>Ловна пушка</h2></a>
        <p>Въздушна пушка модел 2 с 5.5 съчми конусовидни</p>
        <div class="cartAndPrice">
          <h3>1200лв.</h3> <button><i class="fa-solid fa-cart-shopping"></i></button>
        </div>
      </div>
