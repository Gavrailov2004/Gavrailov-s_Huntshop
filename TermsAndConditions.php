...
<body>
  <div class="Hero">
     ...
     <section>
        <h1>Общи условия Gavrailov's shop ЕООД</h1>
        <br>
        <h2>I. ПРЕДМЕТ</h2>
        <br>
        <h3>Чл. 1. Настоящите общи условия са предназначени за регулиране на отношенията между “Gavrailov's shop” EООД, гр. София 1220, ул. Старозагорско Въстание No 34, Район Надежда, ЕИК 201121843, представлявано от Ст. Балчев, наричано по-долу за краткост ДОСТАВЧИК, и клиентите, наричани по-долу ПОЛЗВАТЕЛИ, на електронния магазин „Gavrailov's_shop.com”, наричан по-долу „ЕЛЕКТРОНЕН МАГАЗИН”.</h3>
        <br>
        <h2>ІІ. ДАННИ ЗА ДОСТАВЧИКА</h2>
        <br>
        <h3>Чл. 2. Информация съгласно Закона за електронната търговия и Закона за защита на потребителите</h3>
        <br>
        <h3>1. Наименование на Доставчика: Gavrailov's shop ЕООД</h3>
        <br>
        <h3>2. Седалище и адрес на управление: гр. Варна, 9009 Северна промишлена зона</h3>
        <br>
        <h3>3. Адрес за упражняване на дейността: гр. Варна, ул. Цар Антон Неделчев 21</h3>
        <br>
        <h3>4. Данни за кореспонденция: гр. Варна, Email: blackskull1915@gmail.com , тел: +35999999999</h3>
        <br>
        <h3>5. Вписване в публични регистри: ЕИК 201121843</h3>
        <br>
        <h3>6. Номер на удостоверение за администратор на личните данни No 698706</h3>
        <br>
        <h3>7. Надзорни органи: </h3>
        <br>
        <h2>(1) Комисия за защита на личните данни</h2>
        <br>
        <h3>Адрес: гр. София, ул. „Иван Евстатиев Гешов“ No 15, Email: kzld@government.bg, kzld@cpdp.bg Уеб сайт: www.cpdp.bg</h2>
        <br>
        <h2>(2) Комисия за защита на потребителите</h2>
        <br>
        <h3>Адрес: 1000 гр. София, пл.“Славейков“ No4А, ет.3, 4 и 6, гореща линия: 0700 111 22 Уеб сайт: www.kzp.bg</h3>
        <br>
        <h3>8. Регистрация по Закона за данък върху добавената стойност No BG 201121843</h3>
        <h3>9. Доставчикът е страна по Етичния кодекс на България, достъпен на адрес Gavrailov's_shop.com</h3>
     </section>
     <footer class="footer">
