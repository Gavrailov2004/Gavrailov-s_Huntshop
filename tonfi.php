      ...
      $row_count = mysqli_num_rows($select_rows);?>
        ...
        <div class="pistolsSection">
            <section class="products">
               <h1 class="heading">Всичко за палките и тонфите</h1>
              <div class="box-container">
                  <?php
                  $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Палки и тонфи'");
