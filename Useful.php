...
<body>
  <div class="Hero">
     ...
     <section>
        <h1>Полезно</h1>
        <br>
        <h2>Задължителна ли е регистрация?</h2>
        <br>
        <h3>Не е задължително. Единственото предимство от регистрацията, е че данните ви се запазват и няма нужда да въвеждате отново данните ви и по-бързо се обработват поръчките</h1>
        <br>
        <h2>Локация?</h2>
        <br>
        <h3>Натиснете <a href="contacts.html">тук</a></h1>
        <br>
        <h2>Закупуване на оръжие?</h2>
        <br>
        <h3>По законите на Република България закупуването на всякакъв вид действащи оръжия и боеприпаси за тях, се извършва само и единствено на място в оръжейните магазини, от лица навършили 18г. и срещу съответния документ.</h1>
        <br>
        <h3>Нужни документи</h1>
        <br>
        <h3>*Разрешително: за огнестрелни оръжия и боеприпаси*</h1>
        <br>
        <h3>*Лична карта: за въздушно и газово оръжие.*</h1>
        <br>
        <h3>Доставката чрез куриерски фирми е забранена!</h1>
     </section>
     <footer class="footer">
