...
<body>
  <div class="Hero">
     ...
     <section>
        <h2>Ремонт и технически преглед на оръжия:</h2>
        <h1>*Ремонт на всички видове бойно, ловно и въздушно оръжие</h1>
        <h1>*Удостоверения за годност на оръжие</h1>
        <h1>*Изпитвания, експертизи на оръжие, боеприпаси</h1>
        <br>
        <br>
        <h2>За консултиране посетете <a href="contacts.html">този сайт</a></h2>
     </section>
     <footer class="footer">
